...
const models = {
    standard: genAI.getGenerativeModel({ model: "gemini-3.1-flash-lite-preview" }),
    advanced: genAI.getGenerativeModel({ model: "gemini-3.1-flash-lite-preview" }),
    creative: genAI.getGenerativeModel({ model: "gemini-3.1-flash-lite-preview" })
};
